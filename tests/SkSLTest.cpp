...
SKSL_TEST(CPU + GPU, kApiLevel_T, PreserveSideEffects,             "folding/PreserveSideEffects.sksl")
...
SKSL_TEST(CPU_ES3, kNever, RecursiveComparison_Arrays,     "runtime/RecursiveComparison_Arrays.rts")
SKSL_TEST(CPU_ES3, kNever, RecursiveComparison_Structs,    "runtime/RecursiveComparison_Structs.rts")
SKSL_TEST(CPU_ES3, kNever, RecursiveComparison_Types,      "runtime/RecursiveComparison_Types.rts")
SKSL_TEST(CPU_ES3, kNever, RecursiveComparison_Vectors,    "runtime/RecursiveComparison_Vectors.rts")
